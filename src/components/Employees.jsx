...
const Employees = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editEmployee) {
        await employeesAPI.update(editEmployee._id, formData);
                  ...
                  <tr key={employee._id}>
                    ...
                    <td>
                      <span className={`badge ${
                        ...
                        employee.role === 'hr' ? 'bg-warning' : 'bg-primary'
                      }`}>
                ...
                <div className="modal-body">
                  <div className="row g-3">
                    ...
                    <div className="col-md-6">
                      ...
                      />
                      {editEmployee && <small className="text-muted">Leave blank to keep current password</small>}
                    </div>
                    <div className="col-md-6">
                    ...
                    <div className="col-md-6">
                      ...
                      {formData.department && departments.find(dept => dept._id === formData.department)?.positions?.length === 0 && (
                        <small className="text-warning">No positions defined for this department</small>
                      )}
                    </div>
                    <div className="col-md-6">
                    ...
                    <div className="col-12">
                      <h6 className="fw-bold mt-3">Salary Information</h6>
                    </div>
                    <div className="col-md-4">
